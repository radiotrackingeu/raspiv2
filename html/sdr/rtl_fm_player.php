...
<div class="w3-row row-padding w3-container">
	<div class="w3-panel w3-green w3-round w3-padding-24" >
		<audio controls autoplay preload="none"><source src='<?php echo "http://".$_SERVER['SERVER_NAME'].":".($_SERVER['SERVER_PORT']+1)?>' type='audio/mpeg'>Your browser does not support the audio element.</audio>

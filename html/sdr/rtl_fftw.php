		...
		<div class="w3-panel w3-green w3-round">
			...
			<div id="det<?=$i?>_settings" class="w3-container w3-hide">
                ...
                <p>
					...
					<input class="w3-input w3-mobile" style="width:30%" type="number" id="minDuration_<?=$i?>" name="minDuration_<?=$i?>" step="0.01" value="<?php echo isset($config['logger']['minDuration_'.$i]) ? $config['logger']['minDuration_'.$i] : 0 ?>">
				</p>
                <p>
					<label for="maxDuration_<?=$i?>"> Maximum Signal Length (seconds):</label>
					<input class="w3-input w3-mobile" style="width:30%" type="number" id="maxDuration_<?=$i?>" name="maxDuration_<?=$i?>" step="0.01" value="<?php echo isset($config['logger']['maxDuration_'.$i]) ? $config['logger']['maxDuration_'.$i] : 1 ?>">
				</p>
				<p>

...
# >> RTL-SDR via rtl_sdr
start_rtl_command="rtl_sdr -d 2 -s {samp_rate} -f {center_freq} -p {ppm} -g {rf_gain} -".format(rf_gain=rf_gain, center_freq=center_freq, samp_rate=samp_rate, ppm=ppm)
...
start_mod = "usb" #nfm, am, lsb, usb, cw
